...
Use `Add Profile...` from the menu bar app to create managed profiles:

- `Import from default` copies the system default `~/.codex` and Electron user data into a new managed profile.
