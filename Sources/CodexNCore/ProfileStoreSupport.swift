...
enum ProfileStoreSupport {
    static func randomAPIKeyEnvName(profileID: String) -> String {
    ...
    static func parseCodexNDate(_ value: String) -> Date? {
    ...
    static func formatCodexNDate(_ date: Date) -> String {
